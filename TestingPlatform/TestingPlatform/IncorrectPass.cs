...
namespace TestingPlatform
{
    class IncorrectPass
    {
        ...
        public static void Test()
        {
            ...
            Password.Click();
            Password.SendKeys("qwertyasdsdsadasda");
            ...
            var IsIncorrectLogInfo = false;
            try
            {
                IsIncorrectLogInfo = driver.FindElement(By.XPath("//*/span[text()]")).Enabled;
            }
            catch
            {
                IsIncorrectLogInfo = false;
            }
            Assert.AreEqual(true, IsIncorrectLogInfo);
            Console.WriteLine(IsIncorrectLogInfo);
